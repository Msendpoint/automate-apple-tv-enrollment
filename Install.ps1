<#
.SYNOPSIS
    One-click installer and launcher for Automate Enrollment of Apple TV Devices
...
Write-Host "    Automate Enrollment of Apple TV Devices" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/automate-apple-tv-enrollment.ps1"
